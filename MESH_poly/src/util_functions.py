...
def export_graphs():
    ...
    shutil.copy(os.path.join(get_path(Region, "012"), "cann_I4w_theta", "0", "r2_bestfit.pdf"), os.path.join(output_folder, "r2_bestfit.pdf"))
    shutil.copy(os.path.join(get_path(Region, "012"), "cann_I4ws", "0", "r2_archcomp.pdf"), os.path.join(output_folder, "r2_archcomp.pdf"))
